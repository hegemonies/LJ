...
public class StatementInitList implements Nonterminal {
    private static final List<List<Symbol>> rules = new ArrayList<>();

    static {
        rules.add(Arrays.asList(new StatementInit(), new Punctuation(TypePunctuation.SEMICOLON), new StatementInitList()));
